        ...
        $.ajax({
            ...
            "success": function (response) {
                ...
                for (var i = 0; i < response.data.length; i++) {
                    ...
                    goods.append("<li " + Class + "><img src='" + obj.goods_thumb + "' alt=''><h1>" + obj.goods_name + "</h1><span>￥:" + obj.price + "</span><p>" + obj.goods_desc + "</p><a href='search.html=" + obj.goods_id + "'></a></li>")
                }
            }
        })
    }
